=== Force use of ImageMagick image library (UNMAINTAINED) ===
...
Forces WordPress to use ImageMagick instead of the PHP GD image library. This plugin is no longer maintained.
